 ...
 */
public class PhaseAndMeanPlotPane2 extends ObservationAndMeanPlotPane {
	 ...
	 */
	public PhaseAndMeanPlotPane2(String title, String subTitle,
		...
		// Create a second chart (for standard phase) with legend, tooltips, and
		// URLs showing and add it to the panel. Add previous renderer and
		// dataset.
		// this.chartPanel = new
		// ChartPanel(ChartFactory.createScatterPlot(title,
		// domainTitle, rangeTitle, obsAndMeanModel2, PlotOrientation.VERTICAL,
		// true, true, true));
		//
		// this.chart = chartPanel.getChart();

		// TODO: only actually need one model!

		// for (Integer num :
		// obsAndMeanModel1.getSeriesNumToObSrcListMap().keySet()) {
		// SeriesType type =
		// obsAndMeanModel1.getSeriesNumToSrcTypeMap().get(num);
		// List<ValidObservation> obs =
		// obsAndMeanModel1.getSeriesNumToObSrcListMap().get(num);
		// obsAndMeanModel2.addObservationSeries(type, obs);
		// }
