...
public class WeightedWaveletZTransformWithMods implements IAlgorithm {
	 ...
	 */
	public WeightedWaveletZTransformWithMods(List<ValidObservation> observations,
...
//					System.out.printf("idat: %d, dt[idat]: %f, dtau: %f, dz: %f, dweight: %f, dfre: %f, dmz: %f\n",
//							idat, dt[idat], dtau, dz, dweight, dfre, dmz);
					skip = false;
				...
				if (skip) {
					// TODO: move this decision further down;
					// dweight2 == 0 && dneff == 0: skip?
					continue;
				}
...
//				System.out.printf("dtau: %f, dfre: %f, dmfre: %f, dmz: %f, dpowz: %f, dmamp: %f, dmcon: %f, dmneff: %f, dweight2: %f\n",
//						dtau, dfre, dmfre, dmz, dpowz, dmamp, dmcon, dmneff, dweight2);
