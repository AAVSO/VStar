...
public class HJDConverter {
	 ...
	 * @param ra
	 *            The 1950 epoch right ascension coordinate.
	 * @param dec
	 *            The 1950 epoch declination coordinate.
	 * @return The corresponding Heliocentric Julian Date.
	 */
	public static double convert(double jd, RAInfo ra, DecInfo dec) {
		double hjd = 0;
