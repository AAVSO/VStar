 ...
 */
public class JDComparator implements Comparator<ValidObservation> {

	public static JDComparator instance = new JDComparator();
	
	public int compare(ValidObservation o1, ValidObservation o2) {
		return Double.compare(o1.getJD(), o2.getJD());
	}
}
