...
/**
 * A QLP FITS file observation source plug-in that uses the Topcat FITS library.
 * 
 * See also:<br/>
...
public class QLPFITSObservationSource extends ObservationSourcePluginBase {
    ...
    class QLPFITSObservationRetriever extends TESSObservationRetrieverBase {
        ...
        public boolean validateFITS(BasicHDU[] hdus) {
            ...
            if (!"TIME".equals(tableHDU.getColumnName(0)) || !"SAP_FLUX".equals(tableHDU.getColumnName(2)) || !(
            // Sector 56: column names were changed: KSPSAP_FLUX -> DET_FLUX,
            // KSPSAP_FLUX_ERR -> DET_FLUX_ERR
            ("KSPSAP_FLUX".equals(tableHDU.getColumnName(3)) && "KSPSAP_FLUX_ERR".equals(tableHDU.getColumnName(4)))
                    || ("DET_FLUX".equals(tableHDU.getColumnName(3))
                            && "DET_FLUX_ERR".equals(tableHDU.getColumnName(4))))
