...
public class LightKurveFITSObservationSource extends ObservationSourcePluginBase {
    ...
    public LightKurveFITSObservationSource() {
        super();
        dataSeriesLightKurveKepler = SeriesType.create("Lightkurve Kepler (arbitrary mag)", "Lightkurve Kepler",
                Color.DARK_GRAY, false, false);
        dataSeriesLightKurveTESS = SeriesType.create("Lightkurve TESS (arbitrary mag)", "Lightkurve TESS",
    ...
    class LightKurveFITSObservationRetriever extends TESSObservationRetrieverBase {
        ...
        public boolean validateFITS(BasicHDU[] hdus) {
            ...
            if (!"TIME".equals(tableHDU.getColumnName(0)) || !"FLUX".equals(tableHDU.getColumnName(1))
