 ...
 * arbitrary thing with them. Tool plugins will appear in VStar's Tools menu
 * when its jar file is placed into the VStar plugins directory.
 */
abstract public class ToolPluginBase implements PluginBase {

	/**
	 * Given a list of valid observations, do *something*. :)
	 * 
	 * @param obs
	 *            A list of valid observations. The intention is that this
	 *            should be *all* currently loaded valid observations.
