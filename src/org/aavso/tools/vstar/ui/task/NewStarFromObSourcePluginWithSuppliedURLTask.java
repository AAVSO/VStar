 ...
 */
public class NewStarFromObSourcePluginWithSuppliedURLTask extends
	 ...
	 */
	public NewStarFromObSourcePluginWithSuppliedURLTask(
			ObservationSourcePluginBase obSourcePlugin, URL inputURL,
			boolean isAdditive) {
