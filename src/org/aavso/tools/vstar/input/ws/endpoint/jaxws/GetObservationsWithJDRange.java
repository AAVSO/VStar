...
@XmlRootElement(name = "getObservationsWithJDRange", namespace = "http://endpoint.ws.input.vstar.tools.aavso.org/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getObservationsWithJDRange", namespace = "http://endpoint.ws.input.vstar.tools.aavso.org/", propOrder = {
    "arg0",
    "arg1",
    "arg2"
})
public class GetObservationsWithJDRange {
