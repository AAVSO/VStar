...
@XmlRootElement(name = "getStarInfoByAUIDResponse", namespace = "http://endpoint.ws.input.vstar.tools.aavso.org/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getStarInfoByAUIDResponse", namespace = "http://endpoint.ws.input.vstar.tools.aavso.org/")
