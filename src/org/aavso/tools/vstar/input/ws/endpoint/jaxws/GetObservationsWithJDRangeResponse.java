...
@XmlRootElement(name = "getObservationsWithJDRangeResponse", namespace = "http://endpoint.ws.input.vstar.tools.aavso.org/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getObservationsWithJDRangeResponse", namespace = "http://endpoint.ws.input.vstar.tools.aavso.org/")
public class GetObservationsWithJDRangeResponse {
